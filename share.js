...
Share = (function(_super) {
  ...
  Share.prototype.network_facebook = function() {
    if (this.config.networks.facebook.load_sdk) {
      ...
      return FB.ui({
        method: 'share',
        href: this.config.networks.facebook.url
  ...
  Share.prototype.inject_html = function(instance) {
    ...
    return instance.innerHTML = "<label class='entypo-export'><span>" + this.config.ui.button_text + "</span></label><div class='social load " + this.config.ui.flyout + "'><ul><li class='entypo-twitter' data-network='twitter'></li><li class='entypo-facebook' data-network='facebook'></li><li class='entypo-gplus' data-network='google_plus'></li></li></ul></div>";
  };
